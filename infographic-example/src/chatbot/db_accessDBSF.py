...
class DBAccess:
    ...
    def get_bm25_rank(self, keywords):
        ...
        try:
            ...
            BM25_RANK_QUERY = f"""
                ...
                select codice, cast(bm25rank as float), (select testo from docs where t5.codice=docs.codice), section from (
    ...
    def calculate_embeddings(self, model_path):
        ...
        try:
            ...
            yield "Embeddings calculated and stored successfully."
        except (Exception, psycopg2.Error) as error:
